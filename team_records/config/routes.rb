Rails.application.routes.draw do
  root 'team#home'
  get '/teams/new', to: 'team#new', as: 'new_team'
  post '/teams/create', to: 'team#create', as: 'create_new_team'
  get '/teams/all', to: 'team#index', as: 'teams'
  get '/team/:id', to: 'team#show', as: 'team'
  get '/team/:id/edit', to: 'team#edit', as: 'edit_team'
  post '/team/:id/update', to: 'team#update', as: 'update_team'
  delete '/team/:id/delete', to: 'team#destroy', as: 'delete_team'
